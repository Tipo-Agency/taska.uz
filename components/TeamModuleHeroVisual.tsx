...
export const TeamModuleHeroVisual: React.FC = () => {
  ...
  return (
    <ModuleHeroVisualFrame
      urlSegment="team"
      logoGradientClass="from-rose-500 to-orange-500"
      sidebarActiveIndex={TEAM_NAV_INDEX}
      navIcons={NAV_ICONS}
      sidebarActiveLabel={t('modules.team.demo.sidebarLabel')}
      minHeightClass="min-h-[300px] sm:min-h-[380px] md:min-h-[440px]"
    >
