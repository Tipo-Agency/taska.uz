      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <a href="#" className="flex items-center gap-2 mb-4 group" aria-label={t('header.home')}>
          ...
          <div>
            <h4 className="text-gray-900 font-bold mb-6">{t('footer.product')}</h4>
            <ul className="space-y-3 text-sm text-gray-500">
              <li><a href="#features" className="hover:text-brand transition-colors">{t('footer.capabilities')}</a></li>
              <li><a href="#integration" className="hover:text-brand transition-colors">{t('footer.telegramBot')}</a></li>
              <li><a href="#" className="hover:text-brand transition-colors">{t('footer.forCeo')}</a></li>
              <li><a href="#" className="hover:text-brand transition-colors">{t('footer.forHr')}</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-gray-900 font-bold mb-6">{t('footer.services')}</h4>
            <ul className="space-y-3 text-sm text-gray-500">
              <li><a href="#" className="hover:text-brand transition-colors">{t('footer.crm')}</a></li>
              <li><a href="#" className="hover:text-brand transition-colors">{t('footer.erp')}</a></li>
              <li><a href="#" className="hover:text-brand transition-colors">{t('footer.sales')}</a></li>
              <li><a href="#" className="hover:text-brand transition-colors">{t('footer.chatbots')}</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-gray-900 font-bold mb-6">{t('footer.contacts')}</h4>
            <ul className="space-y-3 text-sm text-gray-500">
